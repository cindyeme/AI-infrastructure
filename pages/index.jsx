        ...
        <div className="max-w-5xl mx-auto">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="hero--paragraph">
              Build and Deploy production ready powerful AI models in 5minutes
            </p>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="hero--box">
                ...
                <p className="__paragraph">
                  Ability to train a model and deploy it for production with an
                  API wrapped around it [sagemaker for production deployment].
                </p>
              </div>
              <div className="hero--box">
                <div className="bg-white rounded-full p-3">
                ...
                <p className="__paragraph">
                  Multiple integration libraries/SDK to consume our service from
                  anywhere (cli, python, php, js, flutter, android, ios,
                  API&apos;s).
                </p>
              </div>
              <div className="hero--box">
                ...
                <p className="__paragraph">
                  Faster way to develop models with well tuned hyper parameters
                  and support for tens of billions of features and samples.
                </p>
              </div>
            </div>
          </div>
